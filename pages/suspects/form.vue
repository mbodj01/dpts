  ...
  <section id="basic-input">
    <div class="row">
      <div class="col-md-12">
        <div class="card">
          <div class="card-body">
            <form action="#" class="needs-validation" novalidate @submit.prevent="handleForm">
              ...
              <div class="row mb-2">
                <div class="col-6">
                  ...
                  <div class="d-flex">
                    <a href="#" class="me-25">
                      <img id="account-upload-img" src="/images/suspect.png" class="uploadedAvatar rounded me-50"
                        alt="profile image" height="100" width="100" />
                    </a>
                    <!-- upload and reset button -->
                    <div class="d-flex align-items-end mt-75 ms-1">
                      <div>
                        <label for="account-upload" class="btn btn-sm btn-primary mb-75 me-75">Charger la photo</label>
              ...
              <div class="row mb-1">
                <div class="col-6">
                  <div class="mb-1">
                    ...
                    <select id="civility" v-model="payload.civilite" required class="form-select">
                  ...
                  <div class="mb-1">
                    ...
                    <input id="prenom" v-model="payload.prenom" required type="text" class="form-control"
                  ...
                  <div class="mb-1">
                    ...
                    <input id="nom" v-model="payload.nom" required type="text" class="form-control"
                  ...
                  <div class="mb-1">
                    ...
                    <input id="date_naissance" v-model="payload.date_naissance" type="text"
                  ...
                  <div class="mb-1">
                    ...
                    <input id="lieu_naissance" v-model="payload.lieu_naissance" type="text" class="form-control"
                  ...
                  <div class="mb-1">
                    <label class="form-label" for="senegalais"> Nationalité sénégalaise* </label>
                    <select id="senegalais" v-model="payload.senegalais" required class="form-select">
                  ...
                  <div class="mb-1 d-flex flex-column">
                    <label class="form-label" for="country">Autre nationalité</label>
                    <client-only placeholder="Chargement...">
                      <vue-country-dropdown :immediate-call-select-event="true" :enabled-flags="true"
                        :enabled-country-code="true" :show-name-input="true" :show-not-selected-option="true"
                        @onSelect="onSelect">
                  ...
                  <div class="mb-1">
                    ...
                    <select id="genre" v-model="payload.sexe" required class="form-select">
                    ...
                    <div class="mb-1">
                      <label class="form-label" for="adresse">Lieu de résidence</label>
                      <input id="adresse" v-model="payload.adresse" required type="text" class="form-control"
                ...
                <div class="col-6">
                  ...
                  <div class="mb-1">
                    <label class="form-label" for="prenom_pere">Prénom du pére*</label>
                    <input id="prenom_pere" v-model="payload.prenom_pere" required type="text" class="form-control"
                  ...
                  <div class="mb-1">
                    <label class="form-label" for="prenom_mere">Prénom de la mére*</label>
                    <input id="prenom_mere" v-model="payload.prenom_mere" required type="text" class="form-control"
                  ...
                  <div class="mb-1">
                    <label class="form-label" for="nom_mere">Nom de la mére*</label>
                    <input id="nom_mere" v-model="payload.nom_mere" required type="text" class="form-control"
                  ...
                  <div class="mb-1">
                    <label class="form-label" for="formule">Formule décadactylaire</label>
                    <input id="formule" v-model="payload.formule" required type="text" class="form-control"
                  ...
                  <div class="mb-1">
                    ...
                    <input id="taille" v-model="payload.taille" required type="text" class="form-control"
                  ...
                  <div class="mb-1">
                    ...
                    <input id="masse" v-model="payload.masse" required type="text" class="form-control"
                  ...
                  <div class="mb-1">
                    ...
                    <input id="profession" v-model="payload.profession" type="text" required class="form-control"
                  ...
                  <label class="form-label" for="motifs">
                    Motif(s)
                  </label>
                  <textarea id="motifs" v-model="payload.motifs" class="form-control" rows="3"
                    placeholder="Entrer les motifs liés au suspect"></textarea>
                  <div class="mb-1">
                    <label class="form-label" for="profession">Procédure</label>
                    <input id="procedure" v-model="payload.procedure" type="text" required class="form-control"
                  ...
                  <div class="mb-1">
                    ...
                    <input id="date" v-model="payload.created_at" type="date" required class="form-control" />
                  ...
                  <div class="mb-1">
                    <label class="form-label" for="fiche">Fiche établie par : </label>
